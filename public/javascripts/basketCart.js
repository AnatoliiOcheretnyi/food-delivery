    ...
    create(){
        ...
        this.containerCounter.addEventListener('click', function(){
            ...
            for(var i = 0; i < productCart.length; i++){
                ...
                var price = productsCreateElement.getElement({ tagName:'div',    className:'price', innerText:productCart[i].price.toLocaleString()+' ГРН' });   
            ...
            var close = productsCreateElement.getElement({tagName: 'div', className: 'cartClose'});
...
var basketCart = new BasketCart('.containerCounter', '.containerCart', productsCatalog);
